...
public class AppLayout extends WebComponent<AppLayout> implements HasClassName {
  ...
  // Panels
  private AbstractDwcjPanel header;
  private AbstractDwcjPanel drawer;
  ...
  /**
   * Using the passed panel in header slot.
   * 
   * @param header the header panel
   * @return the app layout
   */
  public AppLayout setHeader(AbstractDwcjPanel header) {
    this.header = header;
   ...
   * @return the app layout
   */
  public AbstractDwcjPanel getHeader() {
    return header;
  }

  /**
   * Using the passed panel in drawer slot.
   * 
   * @param drawer the drawer panel
   * @return the app layout
   */
  public AppLayout setDrawer(AbstractDwcjPanel drawer) {
    this.drawer = drawer;
   ...
   * @return the app layout
   */
  public AbstractDwcjPanel getDrawer() {
    return drawer;
  }
   ...
   * @return the app layout
   */
  public AppLayout setContent(AbstractDwcjPanel content) {
  ...
  /**
   * Using the passed panel in footer slot.
   * 
   * @param footer the footer panel
   * @return the app layout
   */
  public AppLayout setFooter(AbstractDwcjPanel footer) {
    this.footer = footer;
  ...
  public DrawerPlacement getDrawerPlacement() {
    return DrawerPlacement.valueOf(get(DRAWER_PLACEMENT));
  }
   ...
   * to
   * popover mode. Useful for small screens.
   * 
  ...
  public Shadow getFooterShadow() {
    return Shadow.valueOf(get(FOOTER_SHADOW));
  }
  ...
  public Shadow getHeaderShadow() {
    return Shadow.valueOf(get(HEADER_SHADOW));
  }
